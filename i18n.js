...
var i18n = {
	...
	if(this.__preferences !== null)
	{
		...
		if(preference !== undefined)
		{
			...
			{
			    replacements.push({
				replacement: this.__preferences[i][index],
    ...
    applyOnDocument: function(data)
    {
	var undefined;
	
	var self = this;
	
	var $data = data !== undefined ? $('<div>' + data + '</div>') : null;
	
	var $i18n = data !== undefined ? $('.i18n', $data) : $('.i18n');
